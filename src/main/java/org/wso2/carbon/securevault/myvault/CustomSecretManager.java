package org.wso2.carbon.securevault.myvault;
...
public class CustomSecretManager  {
    private static Log log = LogFactory.getLog(CustomSecretManager.class);

    private final static CustomSecretManager CUSTOM_SECRET_MANAGER = new CustomSecretManager();
    ...
    //hashmap to store all the SecretsRepositoryProviders
    Map<String,SecretRepositoryProvider> providers= new HashMap<>();

    public static CustomSecretManager getInstance() {
        return CUSTOM_SECRET_MANAGER;
    }

    private CustomSecretManager() {
    }
        ...
        for (String secretRepo : repositories) {
            ...
            try {
                ...
                if (instance instanceof SecretRepositoryProvider) {
                    ...
                    providers.put(secretRepo, (SecretRepositoryProvider) instance);
